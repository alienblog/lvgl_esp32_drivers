...
#else
// Detect the use of a shared SPI Bus and verify the user specified the same SPI
// bus for both touch and tft
...
#define SPI_BUS_MAX_TRANSFER_SZ (DISP_BUF_SIZE * 3)
    ...
    defined(CONFIG_LV_TFT_DISPLAY_CONTROLLER_ST7796U) ||   \
...
#define SPI_TFT_CLOCK_SPEED_HZ \
  ((80 * 1000 * 1000) / CONFIG_LV_TFT_CUSTOM_SPI_CLK_DIVIDER)
#else
