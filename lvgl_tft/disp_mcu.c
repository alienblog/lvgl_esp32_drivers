...
static bool mcu_notify_lvgl_flush_ready(esp_lcd_panel_io_handle_t panel_io,
...
void lcd_mcu_lvgl_flush_cb(lv_disp_drv_t* drv, const lv_area_t* area,
                           lv_color_t* color_map)
{
  // use the static one esp_lcd_panel_handle_t panel_handle =
...
extern esp_err_t esp_lcd_new_panel_hx8357(
    const esp_lcd_panel_io_handle_t io,
    const esp_lcd_panel_dev_config_t* panel_dev_config,
    esp_lcd_panel_handle_t* ret_panel);
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_ST7796U
extern esp_err_t esp_lcd_new_panel_st7796u(
    const esp_lcd_panel_io_handle_t io,
    const esp_lcd_panel_dev_config_t* panel_dev_config,
    esp_lcd_panel_handle_t* ret_panel);
#endif
...
void disp_mcu_panel_init(lv_disp_drv_t* disp_drv)
{
  ...
  ESP_ERROR_CHECK(
      esp_lcd_new_panel_hx8357(io_handle, &panel_config, &panel_handle));
#elif defined CONFIG_LV_TFT_DISPLAY_CONTROLLER_ST7796U
  ESP_LOGI(TAG, "Lcd Panel New");
  ESP_ERROR_CHECK(
